...
Gain greater control over your AI agent and the conversational flow. [Create a Pathway Now!](https://portal.luly.ai/)

[Template Pathway Video Tutorial](https://portal.luly.ai/)

## Introduction

Conversational pathways are our new way of prompting Luly that has led to major breakthroughs in realism.
...
<img src="/images/global_node.png" />
...
`Webhook Information` is all you need in order to execute a webhook, and works the same way as Dynamic Data. Refer to the [Dynamic Data](https://portal.luly.ai/) section for more information.
...
Create a pathway now! Click [here](https://portal.luly.ai/)  to get started!

If you have any additional questions, reach out on our [Discord](https://portal.luly.ai/)  and one of our engineers will help
