...
Gain greater control over your AI agent and the conversational flow. [Create a Pathway Now!](https://app.luly.ai/login)
...
`Webhook Information` is all you need in order to execute a webhook, and works the same way as Dynamic Data. Refer to the [Dynamic Data](https://docs.luly.ai/tutorials/dynamic-data) section for more information.
...
Create a pathway now! Click [here](https://app.luly.ai/login)  to get started!

If you have any additional questions, reach out on our [Discord](https://discord.com/invite/QvxDz8zcKe)  and one of our engineers will help
