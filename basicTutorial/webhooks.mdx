...
To create a test webhook visit [Webhook.site](https://portal.luly.ai/)
...
Otherwise, if issues persist, jump into the [discord](https://portal.luly.ai) - one of our teammates will help you asap.
...
Then, follow the [send phone call](https://portal.luly.ai) docs to create and send a phone call. Make sure you include the ```webhook``` as a parameter in your request. After, confirm that the webhook data populated on your webhook site page.

And again, if you encounter issues, jump into [discord](https://portal.luly.ai) and message us - we will help asap.
