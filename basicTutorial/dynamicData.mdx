...
<Accordion title="Expand to see an example in action">
    Here’s how to make an [Inbound Agent](https://docs.luly.ai/api-reference/inbound/update) remember past conversations they’ve had with callers. There’s a lot of other useful information we can integrate, like how long ago that call occurred and the call’s duration.
   
    ```Endpoint: POST https://api.luly.ai/v1/inbound/<<INBOUND NUMBER>>```
    ...
    "dynamic_data": [
        {
            ...
            "url": "https://api.luly.ai/v1/calls",
            "method": "GET",
            "headers": {
        ...
        },
        {
            ...
            "url": "https://api.luly.ai/v1/calls/{{previous_call_id}}",
            "method": "GET",
            "headers": {
                "authorization": <<YOUR API KEY>>
            },
...
By far, the easiest way to test out your `dynamic_data` configuration is via the [/dynamic_data/test](https://docs.luly.ai/api-reference/basic/sendCall) endpoint. It returns the original configuration, every raw response, and the final variables after parsing is applied.
