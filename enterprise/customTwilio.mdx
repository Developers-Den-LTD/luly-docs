...
2. create an  ```encrypted_key``` by [sending an API request](https://portal.luly.ai/) to Luly.
...
1. Go to your [Twilio Console](https://portal.luly.ai/) and get your your Twilio phone number(s).
2. Upload your numbers [through the API](https://portal.luly.ai/) 
...
Once you update an inbound number through the [Dev Portal](https://portal.luly.ai/) or [API](https://portal.luly.ai/), that number will be automatically configured to run on Luly’s infrastructure. No additional steps are required!
