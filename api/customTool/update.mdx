...
<ParamField body="headers" type="object">
    ...
    <Accordion title="Prompt variables examples (Headers)">
    ```json
...
<ParamField body="body" type="object">
    ...
    <Accordion title="Prompt variables examples (Body)">
    ```json
...
<ParamField body="query" type="object">
    ...
    <Accordion title="Prompt variables examples (Query)">
    ```json
...
<ParamField body="input_schema" type="object">
    ...
    [Look here for a general guide on JSON schema structures.](https://portal.luly.ai/)
